...
void SIGN_CH(void)
{
    struct sigaction chmode_act;
    chmode_act.sa_handler = ch_mode;
    sigemptyset(&chmode_act.sa_mask);
    chmode_act.sa_flags =  0;
    sigaction(SIGUSR1,&chmode_act,0);
}
#endif  
